...
{
    public static class ModifyReadWriteModel
    {
        [MenuItem("NFramework/Modify Read/Write To False")]
        public static void ModifySelectedAssetsToFalse()
        {
        ...
        [MenuItem("NFramework/Modify Read/Write To True")]
        public static void ModifySelectedAssetsToTrue()
        {
            // Get all currently selected objects in the Unity Editor
            Object[] selectedObjects = Selection.objects;
